...
public class Relation {
	 ...
	 * 
	 * @param bill
	 *            The bill assigned to this relation.
	 * @param invoice
	 *            The invoice assigned to this relation.
	 */
	 ...
	 * 
	 * This is null, if the relation was autogenerated and is set to the user
	 * who first checks the relation.
	 * 
	 * @return The username.
	 */
	...
	boolean comparePositions(BillPosition bp, InvoicePosition ip) {
		if (bp.quantity == ip.quantity && bp.articleNr == ip.articleNr)
			return true;
		else
			return false;
	}
